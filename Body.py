...
def db_table_val(user_id: int, command: str):
    cursor.execute('INSERT INTO personal (user_id, command) VALUES (?, ?)', (user_id, command))
...
def search_hotel(message):
    ...
    db_table_val(user_id=us_id, command=message.text)
